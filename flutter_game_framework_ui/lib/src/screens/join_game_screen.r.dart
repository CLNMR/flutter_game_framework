...
import 'package:flutter_game_framework_ui/src/screens/join_game_screen.dart';

/// The path and route of the screen.
extension JoinGameScreenRouting on JoinGameScreen {
  /// The path of the screen.
  static const String path = '/joingame';
  ...
  static GoRoute route = GoRoute(
    path: path,
    name: path,
    builder: (context, state) => JoinGameScreen(),
  );
}
